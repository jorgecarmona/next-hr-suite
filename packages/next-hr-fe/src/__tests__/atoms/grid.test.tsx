...
describe('Grid component', () => {
  ...
  test('applies container prop correctly', () => {
    ...
    expect(muiGrid).toHaveAttribute(
      'class',
      expect.stringContaining('MuiGrid-container'),
    );
  });
  ...
  test('applies item prop correctly', () => {
    ...
    expect(muiGrid).toHaveAttribute(
      'class',
      expect.stringContaining('MuiGrid-item'),
    );
  });
  ...
  test('applies xs prop correctly when it is a number', () => {
    ...
    expect(muiGrid).toHaveAttribute(
      'class',
      expect.stringContaining('MuiGrid-grid-xs-6'),
    );
  });
  ...
  test('applies xs prop correctly when it is "auto"', () => {
    ...
    expect(muiGrid).toHaveAttribute(
      'class',
      expect.stringContaining('MuiGrid-grid-xs-auto'),
    );
  });
  ...
  test('applies xs prop correctly when it is true', () => {
    ...
    expect(muiGrid).toHaveAttribute(
      'class',
      expect.stringContaining('MuiGrid-grid-xs-true'),
    );
  });
